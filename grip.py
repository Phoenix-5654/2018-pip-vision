...
class GripPipeline:
    ...
    def __init__(self):
        ...
        self.__hsv_threshold_hue = [50.18, 90.92]
        self.__hsv_threshold_saturation = [41.28, 255.0]
        self.__hsv_threshold_value = [200.88, 255.0]
    ...
    def process(self, source0):
        ...
        # Step Find_Contours0:
        self.__find_contours_input = self.hsv_threshold_output
        self.find_contours_image, self.find_contours_output = self.__find_contours(
